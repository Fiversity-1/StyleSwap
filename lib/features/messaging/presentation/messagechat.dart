...
//Used for demonstrating how to implement flutter alert dialog
            ...
            TextButton(
              onPressed: () async {
                ...
                if (context.mounted) {
                  ...
                  var listing = userManager.currentUser.interestedListings.firstWhere((listing) {
                    return listing.otherUserId == userId;
                  });
                  userManager.currentUser.removeInterestedListing(listing);
                  Navigator.pushNamedAndRemoveUntil(context, "/message", ModalRoute.withName('/profile'));
                }
              },
  ...
  Widget build(BuildContext context) {
    ...
    chatManager.setChatOpened(chatNotifier!.id, true, chatNotifier.previewContent, "5:45pm");
                ...
                //GPT for speed dial direction
                  ...
                  children: [
                                            ...
                                            itemBuilder: (context, index) {
                                              return ListTile(
                                                ...
                                                trailing: IconButton(
                                                  ...
                                                  onPressed: () {
                                                    var ourTradesCopy = List<
                                                        ClothingInfo>.from(chat
                                                        .trades!.ourTrades);

                                                    ourTradesCopy.removeAt(
                                                        index);
                                                    chat.trades =
                                                        MatchedClothing(
                                                            chat.trades!
                                ...
                                return StatefulBuilder(
                                  builder: (BuildContext context,
                                    ...
                                    return SizedBox(
                                      ...
                                      child: ListView.builder(
                                          shrinkWrap: true,
                                          itemCount:  min(chat.trades!.othersTrades.length, 5),
                                          itemBuilder: (context, index) {
                                            return ListTile(
                                              tileColor: Colors.transparent,
                                              minLeadingWidth: 0,
                                              title: CircleAvatar(
                                                ...
                                                child: ClipOval(
                                                child: AspectRatio(
                                                aspectRatio: 1.0, // Ensures a 1:1 ratio
                                                child: Image.memory(
                                                chat.trades!.othersTrades[index].images.first,
                                                fit: BoxFit.cover,
                                            ),
                                                ),
                                            ),
                    ...
                    SpeedDialChild(
                        ...
                        onTap: () {
                          _showReportDialog(context, chat.otherUserId);
                        }),
                  ]),
              IconButton(
                  onPressed: () {
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        FlutterImageStack.widgets(
                            showTotalCount: true,
                            totalCount: chat.trades!.othersTrades.length,
                            itemRadius: 70,
                            itemCount: chat.trades!.othersTrades.isNotEmpty
                                ? chat.trades!.othersTrades.length
                                : _empty.length,
                            itemBorderWidth: 3,
                            children:
                            chat.trades!.othersTrades.isNotEmpty ? chat.trades!
                                .othersTrades.take(2).map((item) {
                              return ClipOval(
                                child: Image.memory(
                                  item.images.first,
                                  width: 100,
                        ...
                        FlutterImageStack.widgets(
                          ...
                          itemBorderWidth: 3,
                          children:
                          chat.trades!.ourTrades.isNotEmpty ? chat.trades!
                              .ourTrades.take(2).map((item) {
                            return ClipOval(
                              child: Image.memory(
                                item.images.first,
                                width: 100,
