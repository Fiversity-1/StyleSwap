  ...
  void fetchUserDetails() async {
    ...
    if (currentUser != null && currentUser.uid == id) {
      ...
      for (var matchedUser in matchedUsers) {
        ...
        interestedListings.add(ChatListing(
            name: matchedUser.name,
            previewContent: messageHistory.last.messageContent,
            time: messageHistory.last.time,
            opened: messageHistory.last.messageType == "sender",
            image: MemoryImage(matchedUser.profilePicture),
...
List<List<ChatMessage>> messages = [
  [
    ChatMessage(
        messageContent: "Hey, are you still looking to trade?",
        ...
        receiverUserId: ""),
    ChatMessage(
        messageContent: "Yes, definitely! What do you have?",
        messageType: "sender",
        time: "4:12pm",
        type: "message",
        senderUserId: "",
        receiverUserId: ""),
    ChatMessage(
        messageContent: "I've got some great vintage tees.",
        messageType: "receiver",
        time: "4:15pm",
        type: "message",
        senderUserId: "",
  ...
  [
    ChatMessage(
        messageContent: "Interested in swapping sneakers?",
        messageType: "sender",
        time: "1:20pm",
        type: "message",
        senderUserId: "",
        receiverUserId: ""),
    ChatMessage(
        messageContent: "Absolutely! What size are you?",
        messageType: "receiver",
        time: "1:22pm",
        type: "message",
        senderUserId: "",
    ...
    ChatMessage(
        ...
        receiverUserId: ""),
    ChatMessage(
        messageContent: "Perfect, me too. Let's see your collection!",
        messageType: "receiver",
        time: "1:25pm",
        type: "message",
        senderUserId: "",
  ...
  [
    ChatMessage(
        messageContent: "Hi there! What do you have up for trade?",
        messageType: "sender",
        time: "9:45am",
        type: "message",
        senderUserId: "",
        receiverUserId: ""),
    ChatMessage(
        messageContent: "Hi! I've got some designer jackets.",
        messageType: "receiver",
        time: "9:50am",
        type: "message",
        senderUserId: "",
        receiverUserId: ""),
    ChatMessage(
        messageContent: "Sounds interesting. Can you send some pics?",
        messageType: "sender",
        time: "9:52am",
        type: "message",
        senderUserId: "",
  ...
  [
    ChatMessage(
        messageContent: "Do you still have that leather jacket?",
        messageType: "receiver",
        time: "7:15pm",
        type: "message",
        senderUserId: "",
        receiverUserId: ""),
    ChatMessage(
        messageContent: "Yes! Are you interested?",
        messageType: "sender",
        time: "7:17pm",
        type: "message",
        senderUserId: "",
        receiverUserId: ""),
    ChatMessage(
        messageContent: "Definitely. What's your asking trade?",
        messageType: "receiver",
        time: "7:19pm",
        type: "message",
        senderUserId: "",
        receiverUserId: ""),
    ChatMessage(
        messageContent: "Looking for a good pair of boots.",
        messageType: "sender",
        time: "7:21pm",
        type: "message",
        senderUserId: "",
  ...
  [
    ChatMessage(
        messageContent: "Hey! Saw your ad, what’s still available?",
        messageType: "sender",
        time: "11:05am",
        type: "message",
        senderUserId: "",
        receiverUserId: ""),
    ChatMessage(
        messageContent: "Hi! Still have the jeans and the hoodie.",
        messageType: "receiver",
        time: "11:08am",
        type: "message",
        senderUserId: "",
        receiverUserId: ""),
    ChatMessage(
        messageContent: "Awesome, I'm interested in the jeans.",
        messageType: "sender",
        time: "11:10am",
        type: "message",
        senderUserId: "",
        receiverUserId: ""),
    ChatMessage(
        messageContent: "Cool, let's make a trade.",
        messageType: "receiver",
        time: "11:12am",
        type: "message",
        senderUserId: "",
