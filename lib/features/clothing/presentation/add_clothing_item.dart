      ...
      switch (activeStep) {
        ...
        case 3: // clothing type
          clothingInfo = clothingInfo.copyWith(
              type: (category.keys.toList()[index] as ClothingType));
          break;
        case 4: // size
          clothingInfo = clothingInfo.copyWith(
              size: LetteredSizing(
                  category.keys.toList()[index] as LetteredSize));
          break;
        case 5: // condition
          clothingInfo = clothingInfo.copyWith(
              condition: (category.keys.toList()[index] as ClothingCondition));
          break;
        case 6: // colours
        ...
        case 7: // gender
          clothingInfo = clothingInfo.copyWith(
              gender: (category.keys.toList()[index] as ClothingGender));
          break;
        case 8: // images
        ...
        case 9: // description
          clothingInfo =
              clothingInfo.copyWith(description: _controllerDescription.text);
          break;
      }
    }
