...
class _AddClothesPreferencesState extends State<AddClothesPreferences> {
  ...
  void didChangeDependencies() {
    ...
    //Prompt: "How to gather arguments pushed in Navigator.pushNamed"
  ...
  //GPT was used for the following reasons:
  //Prompt: "How can I extract and format names of enum from a map of enums?"
  ...
  Widget build(BuildContext context) {
    //GPT was used for the following reasons:
    //Prompt: "Using state management provide an example of how I could track
    //user preferences using provider."
                                  ...
                                  child: GestureDetector(
                                    ...
                                    child: Container(
                                      decoration: BoxDecoration(
                                        ...
                                        boxShadow: [
                                          //GPT was used for the following reasons:
                                          //Prompt: "How to do a shadow on a container in flutter"
                                          BoxShadow(
                                            color:
...
//GPT was used for the following reasons:
//Prompt: "Based on the following enums (provided enums) create a Mapping
//of font awesome icons."
